    ...
    <div class="row my-4">
        <div class="col-lg-12 col-md-12 mb-md-0 mb-4">
          <div class="col-md-12 mt-4">
            <a href="/admin-create-brosur" class="btn btn-xs btn-primary">Brosur Baru</a>
        </div>
          <div class="card">
              ...
              <div class="row">
                <div class="col-lg-6 col-7">
                  ...
                  <p class="text-sm mb-0">
                    ...
                    <span class="font-weight-bold ms-1">---</span>  Daftar Brosur
                  </p>
                </div>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Brosur Name</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Highlight</th>
                        ...
                        <tr>
                          <td>
                              <div class="d-flex px-2 py-1">
                                  <div>
                                    <img src="{{asset('image_brosur/'.$item->brosur_image)}}" class="avatar avatar-sm me-3" alt="team7">
                                  </div>
                                  <div class="d-flex flex-column justify-content-center">
                                      <a href="/admin-edit-brosur/{{$item->id}}" >
                                          <h6 class="mb-0 text-sm">
                                            @if (strlen($item->brosur_name) > 30)
                                                {{substr($item->brosur_name,0,30)}} ...
                                            @else
                                                {{$item->brosur_name}}
                                            @endif
                                          </h6>
        ...
        <form id="form_dell">@csrf
            <div class="modal-body">
                <div class="form-group">
                    <label for="mainmenu_name">Nama Brosur</label>
