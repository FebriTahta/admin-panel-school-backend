                        ...
                        {{-- <html> --}}
                            <head>
                                ...
                                <div class="container d-lg-flex"> <div class="box-1 bg-light user"> <div class="box-inner-1 pb-3 mb-3 "> <div class="d-flex justify-content-between mb-3 userdetails"> <p class="fw-bold">{{$paymenttype->payment_name}}</p></div> 
                                    ...
                                    <button class="carousel-control-prev" type="button" data-bs-target="#my" data-bs-slide="prev"> <div class="icon"> <span class="fas fa-arrow-left"></span> </div> <span class="visually-hidden">Previous</span> </button> <button class="carousel-control-next" type="button" data-bs-target="#my" data-bs-slide="next"> <div class="icon"> <span class="fas fa-arrow-right"></span> </div> <span class="visually-hidden">Next</span> </button> </div> <p class="dis my-3 info">{!!$paymenttype->payment_desc!!} </p><p class="dis mb-3 different">Berikut adalah tahapan "{{$paymenttype->payment_name}}"</p> <div class="dis"> <p class="black"><span class="fas fa-arrow-right mb-3 pe-2"></span>Pengisian Form Pendaftaran</p> <p class="white"><span class="fas fa-arrow-right mb-3 pe-2"></span>Lakukan pembayaran sesuai metode</p> <p class="pastel"><span class="fas fa-arrow-right mb-3 pe-2"></span>Pembayaran terferifikasi secara otomatis</p> </div> <div> </div> </div> </div> <div class="box-2"> 
                                    <div class="box-inner-2"> 
                                        <div> 
                                            <p class="fw-bold">Form {{$paymenttype->payment_name}}</p> 
                                            <p class="dis mb-3">Lengkapi form dibawah ini sebelum melanjutkan ke tahap selanjutnya</p> 
                                        </div> 
                                        <form id="formadd"> @csrf
                                            <input class="form-control" type="hidden" name="paymenttype_id" value="{{$paymenttype->id}}"> 
                                            <div class="mb-3"> 
                                                <p class="dis fw-bold mb-2">Nama lengkap</p> 
                                                <input class="form-control text-uppercase" name="transaksi1_name" type="text" > 
                                            </div>  
                                            <div class="mb-3"> 
                                                <p class="dis fw-bold mb-2">Email address</p> 
                                                <input class="form-control" name="transaksi1_email" type="email" > 
                                            </div> 
                                                <div class="address"> 
                                                    <p class="dis fw-bold mb-3">Alamat lengkap</p> 
                                                    <input type="text" name="transaksi1_alamat" class="form-control text-uppercase" placeholder="Nama Jalan">
                                                    <div class="d-flex"> 
                                                        <input class="form-control zip" name="transaksi1_pos" type="number" placeholder="Kode Pos"> 
                                                        <input class="form-control state text-uppercase" name="transaksi1_kota" type="text" placeholder="Kota"> 
                                                    </div> 
                                                    {{-- <div class=" my-3">
                                                    ...
                                                    <div class="my-3"> 
                                                        <p class="dis fw-bold mb-2">Asal Sekolah</p> 
                                                        <input class="form-control text-uppercase" name="transaksi1_asal" type="text"> 
                                                    </div> 
                                                    <div class="my-3"> 
                                                        <p class="dis fw-bold mb-2">Nomor yang dapat dihubungi</p> 
                                                        <input class="form-control text-uppercase" name="transaksi1_phone" type="number"> 
                                                    </div> 
                                                    <div class="d-flex flex-column dis"> 
                                                        <input type="submit" id="btnadd" class="btn btn-primary mt-2" value="DAFTAR"> 
