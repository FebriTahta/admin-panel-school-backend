    ...
    <div class="row my-4">
        <div class="col-lg-12 col-md-12 mb-md-0 mb-4">
          <div class="col-md-12 mt-4">
            <a href="/admin-create-alumni" class="btn btn-xs btn-primary">Tambahkan Alumni</a>
        </div>
          <div class="card">
              ...
              <div class="row">
                <div class="col-lg-6 col-7">
                  ...
                  <p class="text-sm mb-0">
                    ...
                    <span class="font-weight-bold ms-1">---</span>  Daftar Alumni
                  </p>
                </div>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Alamat Pekerjaan</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Tampilkan</th>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex px-2 py-1">
                                <div>
                                  <img src="{{asset('alumni_image/'.$item->alumni_image)}}" class="avatar avatar-sm me-3" alt="team7">
                                </div>
                                <div class="d-flex flex-column justify-content-center">
                                    <a href="/admin-edit-alumni/{{$item->id}}" >
                                        <h6 class="mb-0 text-sm">
                                          @if (strlen($item->alumni_name) > 30)
                                              {{substr($item->alumni_name,0,30)}} ...
                                          @else
                                              {{$item->alumni_name}}
                                          @endif
                                        </h6>
                        ...
                        <td class="align-middle text-center text-sm">
                            ...
                            onclick="hapus('{{$item->id}}','{{$item->alumni_name}}')"
                            > Hapus </a>
                        </td>
                    </tr>
                    @endforeach
