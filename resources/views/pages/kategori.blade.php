    ...
    <div class="row my-4">
        <div class="col-lg-12 col-md-12 mb-md-0 mb-4">
          <div class="col-md-12 mt-4">
            <a href="##" data-toggle="modal" data-target="#modal-edit" class="btn btn-xs btn-primary">New Kategori</a>
        </div>
          <div class="card">
              ...
              <div class="row">
                <div class="col-lg-6 col-7">
                  ...
                  <p class="text-sm mb-0">
                    ...
                    <span class="font-weight-bold ms-1">---</span>  Daftar Kategori
                  </p>
                </div>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Relasi</th>
                        ...
                        <td>
                            <div class="d-flex px-2 py-1">
                                <div class="d-flex flex-column justify-content-center">
                                    <a data-toggle="modal" data-target="#modal-edit" href="##" onclick="edit('{{$item->id}}','{{$item->kategori_name}}')">
                                        <h6 class="mb-0 text-sm">{{$item->kategori_name}}</h6>
                                    </a>
                                </div>
                            </div>
                        </td>
        ...
        <form id="form_dell">@csrf
            <div class="modal-body">
                <div class="form-group">
                    <label for="mainmenu_name">Nama Kategori</label>
                    <input type="hidden" id="delete_kategori_id" name="id" required>
                    <input type="text" readonly id="delete_kategori_name" name="kategori_name" class="form-control" placeholder="..." required>
                </div>
            </div>
            <div class="modal-footer">
...
@section('script')
<script>
    function edit(id,kategori_name) {
        $('#edit_id').val(id);
