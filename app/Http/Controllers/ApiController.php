...
class ApiController extends Controller
{
    ...
    {
        $data = News::with('kategori')->latest()->first();
        if ($data) {
            # code...
            return ApiFormatter::createApi(200, 'success' ,$data);
        }else {
    ...
    {
        $data = News::orderBy('id','desc')->whereHas('kategori')->paginate(10);
        if ($data) {
            # code...
            return ApiFormatter::createApi(200, 'success' ,$data);
        }else {
    ...
    public function display_banner()
    {
        ...
        $data = Banner::where('banner_highlight', '1')->orderBy('id','DESC')->get();
    ...
    {
        $data = Arsip::whereHas('kategoribuku')->orderBy('id','desc')->limit(3)->get();
        if ($data) {
            # code...
            return ApiFormatter::createApi(200, 'success' ,$data);
        }else {
